...
import 'package:blog_demo/features/blogs/presentation/widgets/blog_editor.dart';
...
class _AddNewBlogPageState extends State<AddNewBlogPage> {
  ...
  void uploadBlog() {
    if (formKey.currentState!.validate() &&
        ...
        image != null) {
      // as user is logged in that's why reached here to upload blog so we mentioned AppUserLoggedIn to get user id
      final posterId =
